...
CONF_PIN_CUSTOM_FIELD: Final = "pin_custom_field"
CONF_PIN_NATIVE_ENABLED: Final = "pin_native_enabled"
CONF_PIN_CUSTOM_ENABLED: Final = "pin_custom_enabled"
CONF_PIN_OFFLINE_PROVISIONING: Final = "pin_offline_provisioning"
LEGACY_CONF_LOXONE_CUSTOM_FIELD: Final = "loxone_custom_field"
...
DEFAULT_PIN_CUSTOM_FIELD: Final = "{{door_code}}"
DEFAULT_PIN_NATIVE_ENABLED: Final = True
DEFAULT_PIN_CUSTOM_ENABLED: Final = True
DEFAULT_PIN_OFFLINE_PROVISIONING: Final = True
...
WEBHOOK_REGISTRATION_RETRY_BASE_SECONDS: Final = 300
WEBHOOK_REGISTRATION_RETRY_MAX_SECONDS: Final = 3600
...
OAUTH_RATE_LIMIT_MAX_DELAY: Final = 24 * 60 * 60
